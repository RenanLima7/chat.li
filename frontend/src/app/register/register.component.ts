...
export class RegisterComponent {
  ...
  cadastro() {
    if (this.email === '' || this.nome === '' || this.confirmarPassword === '' || this.foto === '' || this.genero === 'n-a' || this.password === '') {      
